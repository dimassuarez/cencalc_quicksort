...
! gives the positions of the elements in the original order.
...
! dsr modified to handle integer(kind=16) arrays
...
INTEGER(KIND=16), DIMENSION (:), INTENT(INOUT)  :: list
...
!     Local variables
INTEGER             :: i, j, itemp
INTEGER(KIND=16)    :: reference, temp
