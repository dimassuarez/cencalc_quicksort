...
! USED MODULES
use, intrinsic :: iso_fortran_env, only: int64, real32, real64, int32
use omp_lib
...
integer (kind=int32), dimension(nA), intent(in out) :: indxA
integer (kind=16), dimension(nA), intent(in out) :: A
...
integer (kind=16), dimension(:), allocatable :: left_part    ! temp array for left half of array to be sorted
integer (kind=int32), dimension(:), allocatable :: indx_left_part    ! temp array for left half of array to be sorted
...
abstract interface ! explicit interface block to make sure procedure pointers are given correct arguments
    ...
    subroutine Merge_Interface(A,indxA,nA,B,indxB,nB,C,indxC,nC)
        ...
        integer (kind=16), dimension(nA), intent(in) :: A
        integer (kind=int32), dimension(nA), intent(in) :: indxA
        integer (kind=16), dimension(nB), intent(in) :: B
        integer (kind=int32), dimension(nB), intent(in) :: indxB
        integer (kind=16), dimension(nC), intent(out) :: C
        integer (kind=int32), dimension(nC), intent(out) :: indxC
...
integer (kind=16) :: pivot
integer (kind=16) :: temp
integer (kind=int32) :: marker ,i,j,k
integer (kind=int32) :: eighth
integer (kind=int32) :: temp_indx
integer (kind=16), dimension(9) :: sample
...
integer (kind=16), dimension(nA), intent(in) :: A  ! left part
integer (kind=16), dimension(nB), intent(in) :: B  ! right part
integer (kind=16), dimension(nC), intent(out) :: C ! output array
integer (kind=int32), dimension(nA), intent(in) :: indxA  ! left part
integer (kind=int32), dimension(nB), intent(in) :: indxB  ! right part
integer (kind=int32), dimension(nC), intent(out) :: indxC ! output array
